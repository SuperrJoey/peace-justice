        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <a href="mailto:info@sdg16initiative.org" className="hover:text-blue-300">info@sdg16initiative.org</a>
            </div>
            <div className="flex items-center space-x-2">
              <Globe className="w-5 h-5" />
              <a href="https://sdg16initiative.org" className="hover:text-blue-300">sdg16initiative.org</a>
            </div>
          </div>
        </div>
